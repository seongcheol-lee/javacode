...
public class CustomerManager {
 ...
 // 배열은 인덱스를 필요로 함
        ...
        while (true) {
            ...
            switch (menu.charAt(0)) {
                case 'i':
                    ...
                    break;
                case 'p':
                    printPreviousCustomerData();
                    break;
                case 'n':
                    printNextCustomerData();
                    break;
                case 'c':
                    printCurrentCustomerData();
                    break;
                case 'u':
                    updateCustomerData();
                    break;
    ...
    // 고객 데이터 출력
    public static void printPreviousCustomerData() {
    ...
    public static void printNextCustomerData() {
    ...
    public static void printCurrentCustomerData() {
